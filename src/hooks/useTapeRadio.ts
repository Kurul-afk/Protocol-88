...
export function useTapeAudio() {
  ...
  /**
   * Удар клавиши механической печатной машинки:
   * резкий высокочастотный "щелчок" молоточка + короткий низкий "тук" рычага.
   * Небольшой случайный разброс частоты и громкости на каждый вызов,
   * чтобы серия ударов не звучала как зацикленный сэмпл.
   */
